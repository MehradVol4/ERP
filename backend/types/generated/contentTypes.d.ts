...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    reorder_level: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<10>;
...
export interface ApiPurchasePurchase extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    items: Schema.Attribute.Component<'shared.purchase-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiStockMovementStockMovement
  ...
  attributes: {
    change: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    movement_date: Schema.Attribute.DateTime;
    note: Schema.Attribute.Text;
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    reference: Schema.Attribute.String;
    resulting_stock: Schema.Attribute.Integer;
    type: Schema.Attribute.Enumeration<
      ['sale', 'purchase', 'adjustment', 'return', 'initial']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
